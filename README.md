...
- **Repositorio:** https://github.com/GeroStaffolani/efi_aerolinea
- **Issues:** Para reportar bugs o solicitar features
- **Documentación:** Ver Swagger UI para detalles de API

## 📄 Licencia

Este proyecto es desarrollado como trabajo final integrador para fines educativos.

---

**Desarrollado con ❤️ por Geronimo Staffolani**
